...
qm set $VMID \
  ...
  -boot order=scsi0 \
  -description "<div align='center'><a href='https://Helper-Scripts.com' target='_blank' rel='noopener noreferrer'><img src='https://raw.githubusercontent.com/bal0gtibi/pmve/main/misc/images/logo-81x112.png'/></a>
